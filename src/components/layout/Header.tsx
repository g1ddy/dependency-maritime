          ...
          <SheetContent side="left">
            ...
            <div className="flex flex-col gap-2 mt-4">
              ...
              <Link to="/relationships">
                <Button
                  variant={
                    currentPath === "/relationships" ? "secondary" : "ghost"
                  }
                  className="w-full justify-start"
                >
        ...
        <div className="flex items-center gap-1 border-r pr-4 mr-1">
          <Link to="/">
            <Button
              variant={currentPath === "/" ? "secondary" : "ghost"}
              size="sm"
              className={cn("gap-2", currentPath === "/" && "bg-secondary")}
              aria-label="Dependency Graph"
            >
              <Code className="h-4 w-4" />
              <span className="hidden sm:inline" data-testid="app-title">
                Dependency Graph
              </span>
            </Button>
          </Link>
          <Link to="/relationships">
            <Button
              variant={currentPath === "/relationships" ? "secondary" : "ghost"}
              size="sm"
              className={cn(
                "gap-2",
                currentPath === "/relationships" && "bg-secondary",
              )}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                aria-label="Upload/Select Data Source"
              >
                <Upload className="h-5 w-5" />
              </Button>
            </TooltipTrigger>
            <TooltipContent>Upload/Select Data Source</TooltipContent>
          </Tooltip>
        )}
      </div>
    </header>
